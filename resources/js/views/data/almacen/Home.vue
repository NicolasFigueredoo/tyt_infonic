    ...
    <table>
        ...
        <tbody>
            <tr class="table__search">
                ...
                <td><input type="text" v-model="filters.code" @keyup.enter="applyFilters" /></td>
                <td><input type="text" v-model="filters.name" @keyup.enter="applyFilters" /></td>
                <td><input type="text" v-model="filters.description" @keyup.enter="applyFilters" /></td>
                <td>
                    <div class="btns">
            ...
            <tr v-for="(item, key) in paginator.data" :key="key">
                ...
                <td class="btns">
                    <router-link
                        :to="'/almacen/' + item.id + '/edit'"
                        class="btn btn--green"
                    >
                        <i class="fas fa-edit"></i>
                    </router-link>
                    <router-link
                        :to="'/almacen/' + item.id + '/copy'"
                        class="btn btn--yellow"
                    >
...
<script setup>
    ...
    const syncData = () => {
        ...
        let url = new URL(window.public_path + '/api/almacen')
