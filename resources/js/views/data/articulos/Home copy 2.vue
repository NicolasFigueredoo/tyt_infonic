...
<script setup>
    ...
    watch( pagination.paginator, (value) => {
        flagp.value = 1;
        flag.value++; 
        ...
        if(flag.value > 2 && value.current_page == 1){

            dataPage.value = value.data           
        }
        let pag = document.querySelector(".paginator .paginator__buttons");
    console.log(pag)
    });
    ...
    if(localStorage.getItem('data') !== null) {
        ...
        if(data){
            ...
            console.log('pagination.paginator')
            console.log(pagination.paginator)
            const dataPaginator = JSON.parse(data)
            console.log('data')
            console.log(dataPaginator)
            pagination.paginator = dataPaginator
            console.log('pagination.paginator 2')
            console.log(pagination.paginator)            
