...
@section('content')
    ...
    <div class="d-flex justify-content-center containerEmpresa"
        style="background: #E6E6E6; position: relative; height: 800px;">
        <!-- Contenedor para el contenido de texto -->
        <div class="container">
            <div class="d-flex justify-content-start align-items-start flex-wrap imgTexto">
                <!-- Contenido de texto -->
                <div class="col-12 col-md-6" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="800">
                    <div class="empresaTitle" style="font-weight: 600; font-size: 36px; padding-top: 42px; width: 554px">
                        @if(session('locale') === 'es')
                        {{ $empresa->titulo }}
                        @else
                        {{ $empresa->tituloEnglish }}
                        @endif
                    </div>
                    <br>
                    <div class="empresaDescripcion"
                        style="font-size: 14px; line-height: 22px; font-weight: 400; padding-bottom: 94px; width: 554px">
                    
                    
                        @if(session('locale') === 'es')
                        {{ $empresa->descripcion }}
                        @else
                        {!! $empresa->descripcionEnglish !!}
                        @endif
                    </div>
                </div>
            </div>
        </div>
        <!-- Imagen fuera del contenedor para que se extienda -->
        <div class="col-12 col-md-6 p-0 ps-md-1" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="800"
            style="position: absolute; top: 0; right: 0; height: 100% !important; width: 50%;">
            <img src="{{ asset(Storage::url($empresa->imagen)) }}" class="img-fluid w-100"
                style="height: 100%; object-fit: cover;">
        </div>
    </div>

    <div class="d-flex justify-content-center containerMobile"
        style="background: #E6E6E6; position: relative; height: 800px;">
        <!-- Contenedor para el contenido de texto -->
        <div class="container">
            <div class="row d-flex justify-content-start align-items-start flex-wrap imgTexto">
                <!-- Contenido de texto -->
                <div class="col-12 col-md-12" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="800">
                    <div class="empresaTitle" style="font-weight: 600; font-size: 36px; padding-top: 42px; width: 554px">
                        @if(session('locale') === 'es')
                        {{ $empresa->titulo }}
                        @else
                ...
                <div class="col-12 col-md-12 p-0 ps-md-1" style="margin-bottom: 50px" data-aos="fade-left"
    ...
    <div class="row justify-content-center contenedorC" style="padding-top: 92px; padding-bottom:72px">
        <h2 class="text-center" class="textoHTwo">

            @if(session('locale') === 'es')
            Nuestra empresa se encuentra ubicada en 2 puntos claves
            @else
            Our company is located in 2 key points
            @endif   
        </h2>
    </div>
                    ...
                    <div class="d-flex mapasContacto">
                        ...
                        <div class="col-lg-6 p-4 mr-1 d-flex flex-column justify-content-between"
                            ...
                            <div class="row justify-content-start">
                                ...
                                <span class="name">@if(session('locale') === 'es')
                                    {{ $contacto->name }}
                                    @else
