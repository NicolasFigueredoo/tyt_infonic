...
<div class="container-fluid d-flex justify-content-center flex-column align-items-center footerDiv"
    style="background: linear-gradient(0deg, #161414 1.96%, rgba(22, 20, 20, 0) 95.28%), url({{ asset(Storage::url($inicio->imagenFooter)) }}); height:678px; background-size: cover; background-position: center;">
            ...
            @foreach ($redes as $r)
                <div class="d-flex align-items-center justify-content-center contenedorIconos">
                    <a href="{{ $r->link }}" target="_blank" style="color:transparent;">
                        <img src="{{ asset(Storage::url($r->imagen)) }}" alt="Red social" class="img-fluid"
    ...
    <div class="d-flex flex-row justify-content-center align-items-center fotterM">
        <div class="d-flex flex-row justify-content-center align-items-start flex-wrap box_container">
            <div class="col-12 col-md-2 d-flex align-items-start">
                <img src="{{ asset(Storage::url($logosfooter->image)) }}" class="img-fluid "
            ...
            <div class="col-12 col-md-1 contMobile">
                ...
                <div class="d-flex d-flex align-items-start" style="padding-top: 27px;">
                    <div class="col-6 pcProductos">
                        ...
                        <a href="{{ route('page.productos', ['id' => 36, 'productosVisible' => 0]) }}"
                        ...
                        <a href="{{ route('page.productos', ['id' => 37, 'productosVisible' => 0]) }}"
                            style="color:#fff; text-decoration:none; font-size:16px;line-height: 35px;">Detail</a><br>
                        <a href="{{ route('page.productos', ['id' => 38, 'productosVisible' => 0]) }}"
                            style="color:#fff; text-decoration:none; font-size:16px;line-height: 35px;">Automotor</a><br>
                    </div>
