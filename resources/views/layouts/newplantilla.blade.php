...
<head>
    ...
    {{-- jQuery UNA SOLA VEZ, acá arriba para fotorama --}}
    ...
    <script>
        document.addEventListener('submit', function(e) {
            ...
            grecaptcha.ready(function() {
                grecaptcha.execute('6LdMkUAqAAAAAMX1k3itoW3VlVzFuJOkQTLvnSVF', { action: 'submit' }).then(function(token) {
                    let form = e.target;
    ...
    <style>
        ...
        .manualContainer { width: 281px; height: 282px; }
        ...
        .equipoContainer { width: 300px; height: 130px; }

        .boxNovedad>* { width: 100%; }
        .boxNovedad img { width: 100%; height: auto; }
        .boxNovedad { position: relative; }
        .boxNovedad:hover:before {
            ...
            border-radius: 100%;
            opacity: 0.7; z-index: 99; color: #fff;
            position: absolute; left: 43%; top: 25%;
        }

        #area_privada {
            position: absolute;
            width: 295px; height: 315px;
            top: 15% !important; left: 80% !important;
        ...
        /*
        |----------------------------------------------------------
        | FIX: breakpoint unificado en 992px (igual que Bootstrap lg)
        | Antes estaba en 1000px en el layout y 991.98px en el blade,
        | lo que dejaba una zona donde ambos eran visibles a la vez.
        |----------------------------------------------------------
        */
        .mobileProductos { display: none !important; }

        @media (max-width: 991.98px) {
            .pcProductos  { display: none !important; }
            .mobileProductos { display: flex !important; }

            .popL { padding-left: 0px !important; padding-right: 0px !important; }
            #area_privada { left: 50% !important; top: 50% !important; }
        ...
        @media (min-width: 600px) {
            ...
            .boxNovedad img { width: 266px; height: 212px; }
            .boxNovedad>* { width: 266px; }
        }

        @media (min-width: 1000px) {
            .box_container { width: 1200px; }
        }

        @media (min-width: 1250px) {
            .box_container { width: 1223px !important; }
            .equipoContainer { width: 600px !important; height: 260px !important; }
            .boxNovedad img { width: 366px !important; height: 312px !important; }
            .boxNovedad>* { width: 366px !important; }
            .manualContainer { width: 285px !important; height: 282px !important; }
        }
    </style>
</head>
...
<body>
    ...
    <div id="app">
        ...
        <main>
            ...
            <div id="area_privada" class="ocultar_"
                style="position:absolute;width:295px;height:315px;top:50%;right:13;z-index:101;background:white;border-radius:15px;left: 50%; transform: translateX(-50%);">
                <div class="container">
                                ...
                                <form method="POST" action="{{ route('login.clientes') }}" autocomplete="off">
                                    ...
                                    <div class="mt-3 form-group row d-flex justify-content-center align-items-center">
                                        <div class="col-md-11 d-flex justify-content-between popL">
                                            <span style="color:#F15E40;font-size:20px;">
                                                <b>@if (session('locale') === 'es') INICIAR SESION @else LOGIN @endif</b>
                                            </span>
                                            <button style="border: none; background:transparent; font-size: 20px" class="zp_container">X</button>
                                        </div>
                                        <div class="col-md-10 p-0">
                                            <span style="color:#000;font-size:16px;">
                                                <b>@if (session('locale') === 'es') Email @else Mail @endif</b>
                                            </span>
                                            <input style="background:transparent;color:#000;border-color:#F15E40; border-radius: 35px"
                                    ...
                                    <div class="mt-3 form-group row d-flex justify-content-center align-items-center">
                                        <div class="col-md-10 p-0">
                                            <span style="color:#000;font-size:16px;">
                                                <b>@if (session('locale') === 'es') Contraseña @else Password @endif</b>
                                            </span>
                                            <input style="background:transparent;color:#000;border-color:#F15E40; border-radius: 35px"
                                    ...
                                    <div class="mt-3 form-group row mb-0 d-flex justify-content-center align-items-center">
                                        <div class="col-md-10 d-flex flex-column justify-content-center align-items-center px-0">
                                            <button style="background:#F15E40;color: #fff;border-radius:35px;" type="submit" class="btn w-100">
                                                @if (session('locale') === 'es') Ingresar @else Login @endif
                                            </button>
                                            <a style="color: black !important" href="{{ route('page.registro') }}">
                                                @if (session('locale') === 'es') Quiero ser cliente @else I want to be a client @endif
                                            </a>
                                        </div>
                                    </div>
                                </form>
    ...
    {{-- jQuery principal - una sola versión --}}
    ...
    {{-- Slick carousel - va al final, sin re-cargar jQuery --}}
