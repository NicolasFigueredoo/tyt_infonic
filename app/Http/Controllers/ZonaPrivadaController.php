...

{
...

    {
        ...
        for ($i = 0; $i < count($carritoPedido); $i++) {
            ...
            if ($prod) {
                ...
                if ($descuentoCliente) {
                    ...
                    $subtotalConDescuento = $subtotalSinDescuento - $descuento; // Subtotal después del descuento
        ...
        $respuesta = 'Muchas gracias por su compra. En breve le llegara un e-mail con la confirmación del pedido';
